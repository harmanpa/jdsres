 ...
 * <p>
 * This is a MatVar that specifically is designed to store Int16s. It can only
 * hold shorts and shorts with imaginary components.
 * </p>
 *
 * @author Eider Moore
 * @version 1.0
...
public class MatInt16
    ...
    public Short getNumber(int... index) {
        Short answer = getShort(index);
        return answer;
    }

    /**
     * Everything in a MatInt16 can be returned as a number and none can be
