 ...
 * <p>
 * This is a MatVar that specifically is designed to store floats. It can only
 * hold floats and floats with imaginary components.
 * </p>
 *
 * @author Eider Moore
 * @version 1.0
...
public class MatFloat
    ...
    public Float getNumber(int... index) {
        Float answer = getFloat(index);
        return answer;
    }

    /**
     * Everything in a MatFloat can be returned as a number and none can be
