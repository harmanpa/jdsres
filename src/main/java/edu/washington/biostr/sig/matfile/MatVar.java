 ...
 * <p>
 * No math is included with the MatVar. Some simple math is provided in the
 * class MatMath.</p>
 * <p>
 * The internal structures are 1d arrays of a single data type. These arrays can
 * then be accessed as if they are of any dimensionality using the appropriate
 * methods. The dimensions can be accessed via the dim array.</p>
 * <b>Note</b>
 ...
 * <p>
 * Not all of the functions are needed to be supported by all of the sub
 * classes, just those that can be done.</p>
 *
 * @author Eider Moore
 * @version 1.0
 */
public abstract class MatVar {
     ...
     * don't but this can be overidden by implementing classes to reflect their
     * situations.
     *
    ...
    /**
     * Get the imaginary component corresponding to the given location. On
     * arrays that do not have an imaginary component, this throws an
     * UnsupportedOperationException. By default this exception is always
     * thrown.
     *
     * @param loc The location of the specified component.
     * @return a Number corresponding to the imaginary component at the
     * location.
     ...
     * UnsupportedOperationException. Other subclasses may not have a number at
     * the specified location, in which case a class cast exception will be
     * thrown. Use isNumber() to check if a location contains a number. A
     * location either contains a number or another MatVar.
     *
     ...
     * UnsupportedOperationException. Other subclasses may not have a MatVar at
     * the specified location, in which case a class cast exception will be
     * thrown. Use isNumber() to check if a location contains a MatVar. A
     * location either contains a number or another MatVar.
     *
     * @param loc the location to inspect
    ...
    /**
     * This is designed for setting floating point values. It is mostly used to
     * keep Matfile5Loader simple.
     *
     * @param index
     * @param value
     */
    ...
    /**
     * This is designed for setting integer point values. It is mostly used to
     * keep Matfile5Loader simple. It takes a long because a long is guaranteed
     * for all data types to contain at least the minimum amound of data.
     * However, if the data type is shorter (which is very likely), it will be
     * cast to that datatype.
     *
     * @param index
     * @param value
     */
