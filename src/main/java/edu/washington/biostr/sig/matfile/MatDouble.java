 ...
 * <p>
 * This is a MatVar that specifically is designed to store doubles. It can only
 * hold doubles and doubles with imaginary components.
 * </p>
 *
 * @author Eider Moore
 * @version 1.0
...
public class MatDouble
    ...
    /**
     * Get the imaginary component at the location. The value that is returned
     * is a Double.
     *
     * @param loc The index.
    ...
    public Double getNumber(int... index) {
        Double answer = getDouble(index);
        return answer;
    }

    /**
     * Everything in a MatDouble can be returned as a number and none can be
