...
class Matfile4Loader
    ...
    /**
     * Try and set the endian value. We do this by checking if the first 4 bytes
     ...
     * stored as an array in this format, so we assume that we can see the array
     * header. This does not support reading of sparse matrices yet.
     *
     ...
     * text arrays are stored as floating point numbers with values between 0
     * and 255, so this only supports reading singles and doubles. Returns a
     * MatText value for the next array.
     */
